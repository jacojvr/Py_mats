...
stressT0,strainT0 = mm.stresscalc(displ,strains[1]/1000.,25.,**V)
stressT1,strainT1 = mm.stresscalc(displ,strains[1]/1000.,25.,**V)
stressT2,strainT2 = mm.stresscalc(displ,strains[1]/1000.,100.,**V)
stressT3,strainT3 = mm.stresscalc(displ,strains[1]/1000.,200.,**V)
stressT4,strainT4 = mm.stresscalc(displ,strains[1]/1000.,300.,**V)
stressT5,strainT5 = mm.stresscalc(displ,strains[1]/1000.,400.,**V)
stressT6,strainT6 = mm.stresscalc(displ,strains[1]/1000.,500.,**V)
...
stressT0,strainT0 = mm.stresscalc(displ,strains[1]/0.0001,25.,**V)
stressT1,strainT1 = mm.stresscalc(displ,strains[1]/0.0001,25.,**V)
stressT2,strainT2 = mm.stresscalc(displ,strains[1]/0.0001,100.,**V)
stressT3,strainT3 = mm.stresscalc(displ,strains[1]/0.0001,200.,**V)
stressT4,strainT4 = mm.stresscalc(displ,strains[1]/0.0001,300.,**V)
stressT5,strainT5 = mm.stresscalc(displ,strains[1]/0.0001,400.,**V)
stressT6,strainT6 = mm.stresscalc(displ,strains[1]/0.0001,500.,**V)
...
stresscyc2,straincyc2 = mm.stresscalc(displ,strains[1]/0.0001,200.,**V)
stresscyc3,straincyc3 = mm.stresscalc(displ,strains[1]/1000,25.,**V)
p.close(7)
p.figure(7)
